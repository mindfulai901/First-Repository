    ...
    <div className="w-full max-w-2xl p-8 space-y-8 scroll-container">
      <div className="text-center">
        ...
        <p className="mt-2 text-lg text-gray-600">
          Define how many paragraphs to include in each generated audio file.
        </p>
      </div>
      ...
      <div>
        ...
        <input
            ...
            min="1"
            step="1"
            className="w-full p-3 bg-white border-2 border-gray-400 rounded-lg focus:ring-2 focus:ring-[#9cb89c] focus:border-[#9cb89c] transition duration-300 placeholder-gray-500 text-center text-2xl themed-input"
            value={paragraphsPerChunk === 0 ? '' : paragraphsPerChunk}
            onChange={handleInputChange}
        />
        <p className="text-sm text-gray-500 mt-2 text-center">For single scripts, this splits the output. For batch jobs, this applies to each file.</p>
      </div>
