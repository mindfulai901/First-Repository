...
const ScriptInput: React.FC<ScriptInputProps> = ({ script, setScript, onFilesChange, mode, onNext, onBack }) => {
    ...
    return (
        <div className="w-full max-w-4xl p-8 space-y-6 scroll-container">
            ...
            <div className="flex flex-col sm:flex-row-reverse gap-4">
                ...
                <button 
                  onClick={onBack} 
                  className="w-full flex justify-center py-3 px-4 rounded-md text-2xl font-bold text-black hand-drawn-button bg-[var(--color-secondary)]"
                >
                  Back
                </button>
            </div>
